  ...
  return (
    <div className={b()}>
      ...
      {globalState.selectMode === "tasks" ? (
        <ModalTask active={modalMod} setActive={toggleModal} data={null} />
      ) : (
        <ModalCategory active={modalMod} setActive={toggleModal} data={null} />
      )}
      {/* // <ModalTask active={modalMod} setActive={toggleModal} data={null}/> */}
    </div>
  );
